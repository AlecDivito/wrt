...
// use crate::ast::types::NumberType;

// use super::types::{FloatType, IntType, SignType, ValueType};
...
//     Subtract(NumberType),
//     Multiply(NumberType),
//     Divide(NumberType, Option<SignType>),

//     Remainder(IntType, SignType),
//     And(IntType),
//     Or(IntType),
//     Xor(IntType),
//     Shl(IntType),
//     Shr(IntType, SignType),
//     Rotl(IntType),
//     Rotr(IntType),
...
//     LessThen(NumberType, Option<SignType>),
//     GreaterThen(NumberType, Option<SignType>),
//     LessOrEqual(NumberType, Option<SignType>),
//     GreaterOrEqual(NumberType, Option<SignType>),

//     // Conversions. consume a value of one type and produce a result of another
//     ExtendSigned8(IntType),
//     ExtendSigned16(IntType),
//     I64ExtendSigned32,
