...
// use module::{export::Identifier, function::Frame, instruction::Instruction, module::Module};
// use structure::types::{NumType, ValueType};
...
//                             id
//                         )))?;
//                     let new_frame: Frame<'static> = func_call.from_frame(&frame, &self.modules)?;
...
//                 }
//                 Instruction::I32Const(int) => frame.push(ValueType::Num(NumType::I32(*int))),
//             }
//             i = i + 1;
//         }
//         frame.set_result()
